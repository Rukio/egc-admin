        ...
        <div class="container-block" :class="{container_large: !$store.state.menuDesktopShow}">
            <div class="tittle">
                ...
                <div class="drop_search">
                    <table-filter class="filter" :url="apiUrls.portfolioCategories" name="category" title="title"></table-filter>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getFirstPage() {
                this.setSharedParams([{name: 'portfolio_category_id', value: this.filterItems.category.id}, {name: 'article_author_id', value: this.filterItems.author.id}])
        ...
        created() {
            this.resetModule()
            this.setUrl(this.$store.state.apiUrls.portfolioProjects)
            this.setTextContent({
                titleMain: 'Проекты',
                addItemText: 'Добавить',
                notFoundText: 'Проектов не найдено',
                deleteGreeting: 'Проект успешно удален',
                titleAdd: 'Добавить',
                cancelButton: 'Отмена',
                submitButton: 'Добавить',
                addGreeting: 'Проект успешно добавлен',
                seo: 'SEO'
            })
            this.setFilterItems({
            ...
            this.setSharedParams([{name: 'portfolio_category_id', value: null}])
