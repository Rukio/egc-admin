    ...
    <transition name="slide-y-transition" mode="out-in">
        <div class="table table_middle" v-if="items.length">
            ...
            <table>
                ...
                <tr>
                    <!--<icon-arrowup/>-->
                    <th class="caption">Название проекта<span class="table_move"></span></th>
                    <th class="caption">Категория<span class="table_move"></span></th>
                    <th class="caption">Автор<span class="table_move"></span></th>
                ...
                <tr v-for="item in items" v-bind:key="item.id">
                    ...
                    <td class="caption">
                        {{item.portfolio_category.title}}
                    </td>
                    <td class="caption">
                        {{item.article_author.name}}
                    </td>
