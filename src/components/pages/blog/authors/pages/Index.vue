...
<script>
    ...
    export default {
        ...
        created() {
            this.resetModule()
            this.setUrl(this.$store.state.apiUrls.authors)
            this.setTextContent({
                titleMain: 'Авторы',
                addItemText: 'Добавить',
                notFoundText: 'Авторов не найдено',
                addGreeting: 'Автор успешно добавлен',
                deleteGreeting: 'Автор успешно удален',
                titleAdd: 'Добавить',
                cancelButton: 'Отмена',
                deleteError: 'Невозможно удалить автора, поскольку он имеет статьи',
