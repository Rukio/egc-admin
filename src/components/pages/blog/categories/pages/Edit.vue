        ...
        <div class="container-block" :class="{container_large: !$store.state.menuDesktopShow}">
            <div class="tittle">
                <div class="breadcrumbs">
                    <router-link to="/blog/category">{{textContent.title}}</router-link>
                    <span></span>
            ...
            <div class="edit_main">
                ...
                <div class="folder radius">
                    ...
                    <div class="column round-bottom">
                        <div class="content">
                            <edit-file class="short" title="Изображение" name="seo_image" use-case="seo"></edit-file>
                            <edit-file class="short" title="Иконка" name="icon" use-case="icon"></edit-file>
                        </div>
                    </div>
                </div>
                <div class="buttons">
        ...
        created() {
            ...
            this.init({
                textContent: {
                    ...
                    subtitle: 'Редактирование категории блога',
                    seo: 'SEO информация',
