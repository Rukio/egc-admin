...
<script>
    ...
    export default {
        ...
        created() {
            this.resetModule()
            this.setUrl(this.$store.state.apiUrls.servicesCategories)
            this.setTextContent({
                titleMain: 'Услуги',
                addItemText: 'Добавить',
                notFoundText: 'Услуг не найдено',
                addGreeting: 'Услуга успешно добавлена',
                deleteGreeting: 'Услуга успешно удалена',
                titleAdd: 'Добавить',
                cancelButton: 'Отмена',
                deleteError: 'Невозможно удалить услугу, поскольку она имеет категории',
